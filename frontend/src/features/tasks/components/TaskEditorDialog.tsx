  ...
  return (
    <Dialog open={open} onClose={pending ? () => undefined : onClose}>
      ...
      <div className="fixed inset-0 z-50 grid place-items-end overflow-y-auto p-3 sm:place-items-center sm:p-6">
        <DialogPanel className="max-h-[calc(100dvh-1.5rem)] w-full max-w-xl overflow-y-auto rounded-3xl border border-border/50 bg-surface p-6 text-primary shadow-2xl transition duration-200 data-closed:translate-y-4 data-closed:opacity-0 sm:max-h-[calc(100dvh-3rem)] sm:p-8">

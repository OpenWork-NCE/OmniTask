...
| `overlays/matrix-light.svg`             | Abstract Graphics overlays    | Task toolbar texture in light theme               |
| `overlays/matrix-dark.svg`              | Abstract Graphics overlays    | Task toolbar texture in dark theme                |
...
Each decorative image is hidden from assistive technology and leaves text contrast to semantic color tokens. Mobile and desktop background variants are selected with CSS media queries; light and dark variants follow the resolved document theme.
